...
- Sign Up and Sign In will be posted and retrieved from Realtime Database
- Error message when entering incorrectly
...
**Main Activity** 
- Banner (ViewPager2)
- Product Type, Recommendation (RecyclerView)
- All product images are uploaded to Storage
- All product images displayed in the application are retrieved from Realtime Database (picURL)
...
- List Product, Size (RecyclerView)
...
- Button Plus, button Minus to adjust quantity
- payment and all products will be saved in the order in Realtime Database
...
**My Order Activity**
- Displays the first product in the order
